...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # Level selector
        level_lbl = QLabel("Mode:")
        level_lbl.setStyleSheet(f"color: {TEXT_DIM}; font-size: 12px;")
        ...
        self.level_box.setToolTip(
            "Quick — fast TELEA (small logos)\n"
            "Smart — layered ring fill (large / complex marks)\n"
            "Precision — exemplar patch-match (best quality, slower)"
        )
        self.level_box.setFixedWidth(145)
    ...
    def _do_inpaint(self):
        level = self.level_box.currentIndex()  # 0=Quick 1=Smart 2=Precision
